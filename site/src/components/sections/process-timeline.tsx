                          ...
                          {steps.map((step, i) => (
                              <motion.div
                                            ...
                                            <div className="mb-4 flex items-start justify-between">
                                                            <span className="text-3xl" aria-hidden="true">{step.icon}</span>span>
                                                            <span className="font-[family-name:var(--font-heading)] text-2xl font-black text-[color:var(--brand-lime)] leading-none opacity-40">
                                                              {step.number}
                                                            </span>span>
                                            </div>div>
