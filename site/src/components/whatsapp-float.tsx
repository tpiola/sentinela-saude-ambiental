      ...
      <AnimatePresence>
        {show && (
          <motion.a
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-4 shadow-black/30 ring-[#25D366]/30 md:h-16 md:w-16"
