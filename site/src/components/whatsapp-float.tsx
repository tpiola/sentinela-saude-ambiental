...
export function WhatsAppFloat() {
  ...
  return (
    <div className="fixed right-4 bottom-4 z-[60] flex items-end gap-3 md:right-8 md:bottom-8">
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="rounded-xl bg-white px-4 py-3 text-sm font-semibold text-[color:var(--brand-navy)] shadow-xl ring-1 ring-black/5"
          >
