...
export const BRAND = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Atendemos Franca e Região, mediante agendamento — Batatais, Cristais Paulista, Orlândia, Ituverava, São Joaquim da Barra, Pedregulho e outras conforme disponibilidade. Confirme no WhatsApp a sua localização.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Atendemos Franca e Região, mediante agendamento: Batatais, Cristais Paulista, Orlândia, Ituverava, São Joaquim da Barra, Pedregulho e entorno. Consulte disponibilidade para outras localidades.",
    },
  ],
} as const;
